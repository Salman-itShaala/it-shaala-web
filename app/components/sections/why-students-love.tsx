        ...
        <div className="w-full dark:bg-black bg-white relative flex flex-col gap-8 py-2 sm:px-20">
            <div className="flex flex-col gap-2 z-10">
                <p className="text-blue-600 font-black ">
                    Why Students love {" "}<span className="">IT Shaala
                    </span>
                </p>
...
const items = [
    ...
    },
    {
        ...
        description: "Access assignments/notes and recordings upto 12 months post course completion.",
        header: <Skeleton />,
    ...
    },
    {
        ...
        description: "Students can enjoy the class recordings for revision purpose.",
        header: <Skeleton />,
        icon: <IconArrowWaveRightUp className="h-4 w-4 text-neutral-500" />,
    },
    {
        title: "Have doubts?",
        description: "Get them resolved in the classroom or over text / video by our expert teaching assistants!.",
        header: <Skeleton />,
