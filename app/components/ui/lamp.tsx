    ...
    return (
        <LampContainer>
            ...
            >
                ...
                best IT courses to guide you <br />
...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0 pt-36",
                className
            )}
        >
