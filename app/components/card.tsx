...
const Card = (item: { imgUrl: string, heading: string, subHeading: string }) => {
    return (
        <div className="w-[22vw] h-[76vh] hover:scale-105 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-900 transition-all duration-500 bg-slate-100 rounded-2xl overflow-hidden shadow-2xl p-2 flex flex-col justify-between items-center">
